<x-layout>
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="fw-bold">Add Expense Subcategory</h4>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form method="POST" action="{{ route('expense_subcategory.store') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="sub_category_name" class="form-control @error('sub_category_name') is-invalid @enderror"
                               value="{{ old('sub_category_name') }}" placeholder="Enter subcategory name" required>
