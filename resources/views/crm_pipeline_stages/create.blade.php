<x-layout title="Add CRM Pipeline Stage">
    <h3 class="mb-4">➕ Add New CRM Pipeline Stage</h3>

    <form method="POST" action="{{ route('crm_pipeline_stages.store') }}">
        @csrf
        ...
        <div class="mb-3">
            ...
            <textarea 
                ...
                required>{{ old('what_it_means') }}</textarea>
            @error('what_it_means')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea 
                ...
                required>{{ old('enter_when') }}</textarea>
            @error('enter_when')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea 
                ...
                required>{{ old('exit_when') }}</textarea>
            @error('exit_when')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea 
                ...
                required>{{ old('owner') }}</textarea>
            @error('owner')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>

        <button class="btn btn-primary w-100">Save Stage</button>
    </form>
</x-layout>
